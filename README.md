...
- At **Tesla**, Vivek developed a **real-time web application** that allows General Assembly line Quality Technicians to **log issues faster than the typical system they were using**. Because of this, more data being captured which in turn gave more data insights to make **data driven decisions**. The app recently **helped reducing GA line headcount from 7 to 3** which resulted in **saving $1.18 Million annually** (calc: if $35 per hour is GA line technician Salary, then for 4 (members) * 35 $/ hr * 24 hr/day * 350 days/year = $1.18M annual). It is used now in GA3, EOL and discussions going on to use this on China Gigafactory. The app is heavily adopted and replacing the typical one they were using prior. 
