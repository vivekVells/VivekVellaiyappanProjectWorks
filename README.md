...
- **Saved $1.18M annually at Tesla**. Vivek, as a Full Stack Developer Intern developed a real-time app dashboard which helped to automate & fix non-conformance issues faster in car assembly lines and also helped to reduce technicians presence from 7 to 3 in General car assembly line. The app logs and monitors issues faster than the typical existing system they were using. Because of this, more data being logged which in turn gave more data insights to make data driven decisions. It is now used in GA3, EOL and discussions going on to use this on China Gigafactory. The app is heavily adopted and replacing the typical one they were using prior. (**Calc approx:** if $35 per hour is GA line technician Salary, then for 4 (members) * 35 $/ hr * 24 hr/day * 350 days/year = $1.18M annual).
